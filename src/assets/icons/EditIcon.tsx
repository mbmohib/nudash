export default function EditIcon() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 490.584 490.584">
      <path
        fill="#ffffff"
        d="M100.911 419.404l123.8-51c3.1-2.1 6.2-4.2 8.3-6.2l203.9-248.6c6.2-9.4 5.2-21.8-3.1-29.1l-96.8-80.1c-8-5.9-20.3-6.8-28.1 3.1l-204.9 248.5c-2.1 3.1-3.1 6.2-4.2 9.4l-26 132.1c-1.3 22.6 16.8 26.5 27.1 21.9zm225.7-370.4l65.5 54.1-177.7 217.1-64.9-53.7 177.1-217.5zm-193.2 257.9l44.4 36.8-57.2 23.6 12.8-60.4z"
      />
      <path
        fill="#ffffff"
